...
#include "logo_rgb24_wvga_portrait_T839.h"
#else
...
static int s3cfb_probe(struct platform_device *pdev)
{
   ...
   mDNIe_Mode_Set();
	...
	writel(0xFFFFFFFF, S5P_VA_GPIO + 0x18c);		// GPF3DRV
...
#elif defined(CONFIG_FB_S3C_UPD161224)
extern void uPD161224_ldi_init(void);
extern void uPD161224_ldi_enable(void);
extern void uPD161224_ldi_disable(void);
#endif
...
#if defined(CONFIG_FB_S3C_UPD161224)
